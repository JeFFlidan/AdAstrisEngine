...
{
	LOG_INFO("VulkanSurface::VulkanSurface(): Start creating surface")
#ifdef _WIN32
VkWin32SurfaceCreateInfoKHR createInfo{};
	...
	if (vkCreateWin32SurfaceKHR(device->get_instance()->get_handle(), &createInfo, nullptr, &_surface) != VK_SUCCESS)
		LOG_FATAL("VulkanSurface::VulkanSurface(): Failed to create vulkan surface")
#endif
	...
	LOG_INFO("VulkanSurface::VulkanSurface(): Finish creating surface")
}
