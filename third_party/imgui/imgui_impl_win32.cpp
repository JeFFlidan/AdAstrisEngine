...
static bool ImGui_ImplWin32_InitEx(void* hwnd, bool platform_has_own_dc, Win32ClientApi client_api)
{
...
{
    return ImGui_ImplWin32_InitEx(hwnd, false, Win32ClientApi_Unknown);
}

IMGUI_IMPL_API bool     ImGui_ImplWin32_InitForOpenGL(void* hwnd)
{
    // OpenGL needs CS_OWNDC
    return ImGui_ImplWin32_InitEx(hwnd, true, Win32ClientApi_OpenGL);
}

IMGUI_IMPL_API bool     ImGui_ImplWin32_InitForVulkan(void* hwnd)
{
    return ImGui_ImplWin32_InitEx(hwnd, false, Win32ClientApi_Vulkan);
}
