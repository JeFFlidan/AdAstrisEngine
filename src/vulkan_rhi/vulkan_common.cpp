...
VkImageLayout vulkan::get_image_layout(rhi::ResourceLayout resourceLayout)
{
	switch (resourceLayout)
	{
		...
		case rhi::ResourceLayout::SHADER_READ_ONLY:
			return VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
		case rhi::ResourceLayout::TRANSFER_SRC:
			return VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL;
		case rhi::ResourceLayout::TRANSFER_DST:
			return VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL;
		case rhi::ResourceLayout::COLOR_ATTACHMENT:
			return VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL;
		case rhi::ResourceLayout::DEPTH_STENCIL:
			return VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL;
		case rhi::ResourceLayout::DEPTH_STENCIL_READ_ONLY:
