...
namespace ad_astris::resource::utils
{
	...
	void pack_model_info(ModelInfo* modelInfo, ResourceInfo* resourceInfo);
	ModelInfo* unpack_model_info(ResourceInfo* resourceInfo);
	
	void pack_texture_info(TextureInfo* textureInfo, ResourceInfo* resourceInfo);
	TextureInfo* unpack_texture_info(ResourceInfo* resourceInfo);
	
	void pack_level_info(LevelEngineInfo* levelInfo);
	LevelEngineInfo unpack_level_info(ResourceInfo* resourceInfo);
}